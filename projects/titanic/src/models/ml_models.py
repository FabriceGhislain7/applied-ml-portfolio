...
from projects.titanic.src.config import ML_MODELS
...
def get_model_complexity_score(model):
    """
    Calcola un punteggio di complessitÃ  del modello
    """
    logger.debug("Calcolo complessitÃ  modello")
    ...
    if hasattr(model, 'n_estimators'):
        ...
        logger.debug("Usando valore di default per complessitÃ ")
